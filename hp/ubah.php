...
$sql = "select * from hp where id=" . $_GET['id'] . "";
$result = pg_query($sql);
...
<head>
    ...
    <title>REKAM DATA HP | CRUD</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg text-uppercase" style="background-color: blue ">
        <div class="container d-flex justify-content-center">
            <a class="navbar-brand " style="color: black" href="index.php">PEREKAMAN DATA HP | CRUD</a>
    ...
    <div class="row m-2">
        <div class="col-7">
            <form method="post" >
              ...
              <div class="form-group row my-1">
                <label for="Seri" class="col-sm-2 col-form-label">Tipe</label>
                <div class="col-sm-10">
...
if(isset($_POST['id']) and !empty($_POST['id'])) {
    $sql = "update hp set merek='" . $_POST['merek'] . "', tipe='" . $_POST['tipe'] . "', tahun='" . $_POST['tahun'] . 
        "' where id='" . $_POST['id'] . "'";
